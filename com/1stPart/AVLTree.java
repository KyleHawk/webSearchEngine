...
public class AVLTree<AnyType extends Comparable<? super AnyType>>
{
 ...
 //Returns all values stored in the tree
 public List<String> treeToList( )
 {
     ...
     else
     {
         ...
         treeToList( root, treeWords);
         return treeWords;
     }
 }
 
 private void treeToList( AvlNode<AnyType> t, List<String> treeWords )
 {
	 
     if( t != null )
     {
    	 treeToList( t.left, treeWords );
         treeWords.add((String) t.element );
         treeToList( t.right, treeWords );
     }
